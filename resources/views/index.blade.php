...
<head>
    ...
    <!-- ==========================
    	Favicons
    =========================== -->
    <link rel="shortcut icon" href="{{ URL::asset('assets/icons/favicon.ico') }}">
    ...
    <link href="{{ URL::asset('assets/css/creative-brands.css') }}" rel="stylesheet" type="text/css">
    <link href="{{ URL::asset('assets/css/vertical-carousel.css') }}" rel="stylesheet" type="text/css">
...
<body id="page-top">
        ...
        <nav class="navbar navbar-default navbar-fixed-top" role="navigation">
            <div class="container">
                ...
                <div class="navbar-header">
                    ...
                    <img src="{{ URL::asset('assets/image/jonathan.png') }}" class="navbar-logo pull-left" alt="" />
                    <a href="index.html" class="navbar-brand animated flipInX">John Doe</a>
                </div>
                                              ...
                                              <div class="carousel-inner">
                                               <!-- Slideshow item 1 active -->
                                                  <div class="item active">
                                                        <p>Hi everyone i just finished my last #awesome web template you can check it on #wrapbootstrap.. Fully responsive and mobile first webtheme.co</p>
                                                  </div>
                                               <!-- Slideshow item 2 -->
                                                  <div class="item">
                                                        <p>Check our new amazing portfolio on #Pixelized</p>
                                                  </div>

                                                <!-- Slideshow item 3 -->
                                                  <div class="item">
                                                        <p>Another very #important tweet from your twitter.</p>
                                                  </div>
                                              </div>
                                         </div>
                                    </div>
        ...
        <div class="container">
            <div class="row scrollpoint sp-effect3">
                <div class="col-sm-2">
                    ...
                    <p><span class="number highlight" data-from="0" data-to="1000" data-refresh-interval="10"></span> Happy clients</p>
                </div>
                <div class="col-sm-2">
    ...
    <section id="reference" class="content-second">
        <h2 class="scrollpoint sp-effect3">Reference</h2>
        <p class="scrollpoint sp-effect3">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce in turpis quam. Nulla quis eleifend lectus.</p>
                ...
                <div class="col-sm-12">
                    ...
                    <div class="macbook-inner black">
                    	<div class="row scrollpoint sp-effect4">
                            ...
                            <img src="image/jonathan.png" class="contact-image image-responsive hidden-xs hidden-sm" alt="" />
